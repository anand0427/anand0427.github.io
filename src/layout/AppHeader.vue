<template>
    <!-- <header class="header-global">
        <base-nav class="navbar-light-bg" transparent type="" effect="light" expand>
            <router-link slot="brand" class="navbar-brand mr-lg-5" to="/">
                <img src="img/brand/white.png" alt="Anand">
            </router-link>

            <div class="row" slot="content-header" slot-scope="{closeMenu}">
                <div class="col-6 collapse-brand">
                    <a onClick="alert('Link not yet working. Please come back later')">
            ...
            <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                <base-dropdown class="nav-item" menu-classes="dropdown-menu-xl">
                    ...
                    <div class="dropdown-menu-inner">
                        <a onClick="alert('Still building please come back later')"
            ...
            <!-- <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <span class="btn-inner--icon">
                  <i class="fa fa-cloud-download mr-2"></i>
                        ...
                        <span class="nav-link-inner--text">Download Resume</span>
                    </a>
                </li> -->
            <!-- </ul> -->
        <!-- </base-nav>
